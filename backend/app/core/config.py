...
class Settings:
    ...
    database_url: str = os.getenv(
        "DATABASE_URL",
        "postgresql+psycopg://interviewiq_demo:password@localhost:5432/interviewiq_demo",
    )
    ...
    s3_access_key: str = os.getenv("S3_ACCESS_KEY", "minioadmin_demo")
    s3_secret_key: str = os.getenv("S3_SECRET_KEY", "minioadmin_demo")
    s3_bucket: str = os.getenv("S3_BUCKET", "interviewiq-audio-demo")
